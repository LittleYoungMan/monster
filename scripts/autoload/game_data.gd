...
func _load_weapons() -> void:
	var csv_path: String = "res://assets/data/weapons.csv"
...
func _load_projectiles() -> void:
	var csv_path: String = "res://assets/data/projectiles.csv"
...
func _load_summon_units() -> void:
	var csv_path: String = "res://assets/data/summon_units.csv"
